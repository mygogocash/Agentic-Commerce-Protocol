...
const VerifyNumberPhone = () => {
  ...
  return (
    <SubPage title="Verify Phone" showSubMenu>
      <h1 className=" text-[#00B14F] text-[26px] font-semibold">
        Change Your Phone Number
      </h1>
      <div>
        <h5 className="text-black text-[16px]">Enter Current Phone Number</h5>
        <p className="text-[14px] text-[#656565]">
          To keep your account secure, please enter current mobile phone number
          linked to your account before updating your phone number.
        </p>
      </div>
      <Step />
      <div
